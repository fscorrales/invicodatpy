...
class SaldoMotivo(RPWUtils):
    ...
    _REPORT_TITLE:str = field(
        ...
        default='EVOLUCIÓN DE SALDOS POR MOTIVO'
    )
    _TABLE_NAME:str = field(
        init=False, repr=False, 
        default='saldo_motivo'
    )
        ...
        try:
            ...
            for ejercicio in ejercicios:
                ...
                if int_ejercicio > 2010 and int_ejercicio < (dt.datetime.now().year + 1):
                    ...
                    self.sgv.wait.until(EC.presence_of_element_located(
                        (By.XPATH, "/html/body/form/div[3]/table/tbody/tr/td[1]/div/table[2]/tbody/tr/td[3]/div[2]/span/div/table/tbody/tr[4]/td[3]/div/div[1]/div/table/tbody/tr/td/table/tbody/tr[1]/td/table/tbody/tr/td/table/tbody/tr[4]/td[3]/table")
                    ))
                    ...
                    self.sgv.rename_report(
                        dir_path, 
                        'RecuperosInformeEvolucionDeSaldosPorMotivos.xlsx', 
                        ejercicio + '-InformeEvolucionDeSaldosPorMotivos.xlsx'
                    )
                    time.sleep(1)
...
def main():
    ...
    if args.download:
        ...
        if args.username != '' and args.password != '':
            ...
            if os.path.isfile(json_path):
                ...
                json_file.close()
        sgv = SaldoMotivo(sgv = sgv_connection)
        sgv.download_report(
    ...
    file = file[0] + '-InformeEvolucionDeSaldosPorMotivos.xlsx'
