...
class SaldoBarrioVariacion(RPWUtils):
    ...
    _REPORT_TITLE:str = field(
        ...
        default='EVOLUCIÓN DE SALDOS POR BARRIO'
    )
    _TABLE_NAME:str = field(
        init=False, repr=False, 
        default='saldo_barrio_variacion'
    )
    ...
    def download_report(
        ...
        try:
            ...
            self.sgv.driver.get('https://gv.invico.gov.ar/App/Recupero/Informes/InformeEvolucionDeSaldosPorBarrio.aspx')

            time.sleep(1)

            # Llenado de inputs
            xpath_input_gral = "//table[@class='tablaFiltros']//input"
            xpath_ejercicio = "//input[@id='ctl00_ContentPlacePrincipal_ucInformeEvolucionDeSaldosPorBarrio_txtAño_TextBox1']"
            ...
            for ejercicio in ejercicios:
                ...
                if int_ejercicio > 2010 and int_ejercicio < (dt.datetime.now().year + 1):
                    ...
                    btn_export = self.sgv.driver.find_element(By.XPATH, "//a[@id='ctl00_ContentPlacePrincipal_ucInformeEvolucionDeSaldosPorBarrio_rpInformeEvoSaldosPorBarrio_ctl05_ctl04_ctl00_ButtonLink']")
                    btn_export.click()
                    time.sleep(1)
                    ...
                    self.sgv.rename_report(
                        dir_path, 
                        'InformeEvolucionDeSaldosPorBarrio.xlsx', 
                        ejercicio + '-InformeEvolucionDeSaldosPorBarrio.xlsx'
                    )
                    time.sleep(1)
...
def main():
    ...
    if args.download:
        ...
        if args.username != '' and args.password != '':
            ...
            if os.path.isfile(json_path):
                ...
                json_file.close()
        sgv = SaldoBarrioVariacion(sgv = sgv_connection)
        sgv.download_report(
    ...
    file = file[0] + '-InformeEvolucionDeSaldosPorBarrio.xlsx'
